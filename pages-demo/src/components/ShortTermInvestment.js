...
function ShortTermInvestment() {
    ...
    React.useEffect(() => {
        ...
        if (screnSize === 'desktop') {
            ...
            axios.get('http://127.0.0.1:8000/api/ShortTerm_data/Desktop')
        ...
        if (screnSize === 'tab') {
            ...
            axios.get('http://127.0.0.1:8000/api/ShortTerm_data/Tab')
                .then(function (response) {
                    // handle success
        ...
        if (screnSize === 'mobile') {
            ...
            axios.get('http://127.0.0.1:8000/api/ShortTerm_data/Mobile')
                .then(function (response) {
                    // handle success
    ...
    return (
        <div className='p-3 h-full bg-gray-100 relative'>
            <h2 className='text-center text-lg font-semibold pb-2'>SHORT TERM INVESTMENT</h2>
            {pageData !== null ? (
